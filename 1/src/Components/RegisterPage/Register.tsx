      ...
      <div className={styles.registerformdiv}>
        <form action="" className={styles.form}>
          ...
          <div className={styles.registertrio}>
            ...
            <div className={styles.inputs}>
              <input type="text"  onChange={handleChange} placeholder="First name" name="firstName" value={formData.firstName} required/>
            </div>

            <div className={styles.inputs}>
              <input type="text"  onChange={handleChange} placeholder="Last Name" name="lastName" value={formData.lastName} required />
            </div>
          </div>
          <div className={styles.inputs}>
            <input type="email"  onChange={handleChange} placeholder="Enter Email" name="email" value={formData.email} required />
          </div>
          <div className={styles.inputs}>
